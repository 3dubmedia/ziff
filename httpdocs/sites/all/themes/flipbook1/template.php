 ...
 */
function flipbook1_html_head_alter(&$head_elements) {
 ...
 */
function flipbook1_breadcrumb($variables) {
 ...
 */
function flipbook1_menu_local_tasks(&$variables) {
  $output = '';
...
function flipbook1_page_alter($page) {
